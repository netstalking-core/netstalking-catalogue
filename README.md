...
[Kompas Research]() - Мы разрабатываем инструмент, который может помочь любому лучше ориентироваться в новостях и инфосреде. Нам нужны программисты на Python, журналисты и энтузиасты.
